    ...
    t.extend(t.fn, {
        ...
        rules: function(e, i) {
            ...
            if (null != h && null != h.form) {
                if (e)
                    switch (s = t.data(h.form, "validator").settings, r = s.rules, n = t.validator.staticRules(h), e) {
                    case "add":
        ...
        prototype: {
            ...
            elements: function() {
                ...
                return t(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    return !s && e.settings.debug && window.console && console.error("%o has no name assigned", this), this.hasAttribute("contenteditable") && (this.form = t(this).closest("form")[0]), s in i || !e.objectLength(t(this).rules()) ? !1 : (i[s] = !0, !0)
                })
            },
            clean: function(e) {
                return t(e)[0]
        ...
        normalizeRules: function(e, i) {
            return t.each(e, function(s, r) {
                ...
                if (r.param || r.depends) {
                    ...
                    n ? e[s] = void 0 !== r.param ? r.param : !0 : (t.data(i.form, "validator").resetElements(t(i)), delete e[s])
                }
        ...
        methods: {
            ...
            step: function(e, i, s) {
                ...
                if (h)
                    throw new Error(a);
                return r = u(s), (u(e) > r || d(e) % d(s) !== 0) && (c = !1), this.optional(i) || c
            },
